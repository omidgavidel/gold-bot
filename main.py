...
print("ربات با حالت فوق‌العاده سبک و کم‌مصرف استارت شد...", flush=True)
send_telegram_message("🟢 ربات ترید طلا با حالت ضد-تووقف روشن شد.")

last_signal_time = None

while True:
    try:
        # استفاده از period=1d برای کاهش شدید مصرف رم و جلوگیری از متوقف شدن توسط ریلی
